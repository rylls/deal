      ...
      <body className="h-full flex bg-white text-[#1d1d1f] overflow-hidden selection:bg-[#0071e3]/20">
        ...
        <aside className="w-[240px] bg-[#f5f5f7] border-r border-[#d2d2d7]/50 flex flex-col shrink-0 h-full pt-14 pb-6 px-4">
          <div className="px-3 mb-8">
            <h2 className="text-[11px] font-semibold text-[#86868b] uppercase tracking-wider">Focus Workspace</h2>
          </div>
          
          <nav className="flex-1 space-y-1">
            <Link 
              href="/" 
              className="flex items-center px-3 py-2 text-[13px] font-medium rounded-lg text-[#1d1d1f] hover:bg-[#e8e8ed] apple-transition"
            >
              Dashboard
            </Link>
            <Link 
